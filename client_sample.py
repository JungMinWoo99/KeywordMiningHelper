...
keyword_del_button = tkinter.Button(window, text="단어 삭제", width=15, height=1, command=remove_word, repeatdelay=1000, repeatinterval=100)
keyword_del_button.place(x=430, y=450)

min_num_input = tkinter.Text(window, width=10, height=1)
min_num_input.place(x=560, y=493)

min_filter_button = tkinter.Button(window, text="최소빈도필터", width=15, height=1, command=filter_min, repeatdelay=1000, repeatinterval=100)
min_filter_button.place(x=430, y=490)

min_filter_button = tkinter.Button(window, text="워드 클라우드 생성", width=15, height=1, command=wc_gen, repeatdelay=1000, repeatinterval=100)
